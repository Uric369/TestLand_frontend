            ...
            <Flex flexDirection='column'>
                ...
                <Flex margin="40px" flexDirection='column'>
                    <Stack direction='row' marginBottom={"20px"}>
                        <Badge fontSize='xl'>字符串</Badge>
                        <Badge colorScheme='green' fontSize='xl'>最小生成树</Badge>
                        <Badge colorScheme='red' fontSize='xl'>图论</Badge>
                        <Badge colorScheme='purple' fontSize='xl'>Dijkstra</Badge>
                        <Badge colorScheme='purple' fontSize='xl'>Dijkstra</Badge>
                    </Stack>
                    <Stack direction='row'>
                        <Badge fontSize='xl'>字符串</Badge>
