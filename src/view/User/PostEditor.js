...
const PostEditor = () => {
   ...
   const user=JSON.parse(localStorage.getItem("user"));
    ...
    const handleUpload = (event) => {
      ...
      axios.post("http://localhost:8080/uploadImage", formData).then((res) => {
            ...
            <CardHeader>
                <Flex justify='space-between' flexDirection="column"  align='center' minHeight='60px' w='100%'>
                    ...
                    <FormControl pt="50px">
                            ...
                            <Flex>
          <Input w="80%" type="file" onChange={handleFileChange} placeholder=''/>
